...
//********************************************* logIN PAGE *****************************************************
	...
	public void page_title_should_be(String expectedTitle) throws InterruptedException {
		...
		{
			log.warn("Test passed :login feature: Page tittle matched");
		...
		else
		{
			...
			log.warn("Test failed :login feature: Page tittle not matched");
...
{	
	...
	if(sc.isFailed()==true)
	{
		...
		String filewithpath="C:\\Users\\admin\\eclipse-workspace\\cucumber\\CucumberFramework\\Screenshots\\failedscrnshot02.png";
